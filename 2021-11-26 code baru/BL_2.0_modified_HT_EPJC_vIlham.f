...
C--------------------
      OPEN (unit=8,STATUS='unknown',FILE='BL 2.0 BSP_MIAIBLX_1.txt')
      OPEN (unit=9,STATUS='unknown',FILE='BL 2.0 BSP_CRMIAIBLX_1.txt')
      OPEN (unit=10,STATUS='unknown',FILE='BL. 2.0 MASSCORR&DEFORM.txt')
