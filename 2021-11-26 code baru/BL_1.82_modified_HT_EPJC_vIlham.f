...
C--------------------
      OPEN (unit=8,STATUS='unknown',FILE='BL 1.82 BSP_MIAIBLX_1.txt')
      OPEN (unit=9,STATUS='unknown',FILE='BL 1.82 BSP_CRMIAIBLX_1.txt')
      OPEN (unit=10,STATUS='unknown',FILE='BL 1.82 MASSCORR&DEFORM.txt')
...
C     Define things related to derivative of AICORR with rescpect to P
     ...
     &       /(1.D0-2.D0*GS*MASST*MSS/XA))
      ...
      SATU=2*XA*(1.D0+PRESS/EDEN)*(1.D0+3.D0*PRESS/EDEN)*EDEN/PAKSEN
     
      DUA=-1.D0*(XA*XA*(1.D0+PRESS/EDEN)*(1.D0+3.D0*PRESS/EDEN)*EDEN
     &    *(2.D0*GS*MASST*MSS/(PAKSEN*XA**2)
     &    -2.D0*GS*4.D0*PI*EDEN*XA**2/(PAKSEN*XA)))
     &    /(1.D0-2.D0*GS*MSS*MASST/XA)
     
      TIGA=XA*XA*(1.D0+PRESS/EDEN)*(1.D0+3.D0*PRESS/EDEN)*DFED(PRESS)
     &     +XA*XA*(1.D0+PRESS/EDEN)*EDEN*((3.D0/EDEN)-3.D0*PRESS
     &     *DFED(PRESS)/EDEN**2)
    
      EMPAT=XA*XA*(1+3.D0*PRESS/EDEN)*EDEN*((1.D0/EDEN)-PRESS
     &      *DFED(PRESS)/EDEN**2)
