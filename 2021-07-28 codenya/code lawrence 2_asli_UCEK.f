...
C--------------------
      OPEN (unit=8,STATUS='unknown',FILE='BSP_MIAIBLX.txt')
      OPEN (unit=9,STATUS='unknown',FILE='BSP_CRMIAIBLX.txt')
      OPEN (unit=10,STATUS='unknown',FILE='MASSCORR&DEFORM.txt')
...
C      solving dp_0/dr; one, two, three, four are terms in the eq
      ...
      ONE=GS*Mo*MSS*(1.D0+8.D0*GS*PI*XA*XA*PRESS)/((XA-2.D0*GS*MSS
