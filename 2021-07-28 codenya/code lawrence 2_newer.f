...
C--------------------
      OPEN (unit=8,STATUS='unknown',FILE='BSP_MIAIBLX_mod.txt')
      OPEN (unit=9,STATUS='unknown',FILE='BSP_CRMIAIBLX_mod.txt')
...
C        stop
       ...
       RNS2=ROS2*1.D3
       DBS=1.D0-2.D0*GS*GMOS2*MSS/RNS2
       KC=0.5D0*DLOG(DBS)-MNURT
       PRINT*,"LOG(1-2GM/R)/2-MU=",KC,"  OMET=",OMGA
...
C      total mass, polar radius, equator radius, aveage radius, eccentricity, and ellipticity        
       ...
       print*, GMOS2,MTOT,ROS2,RTOTP,RTOTE
