...
C        stop
 ...
 30    PMIN=1.0D-9
       ...
       PRINT*,"LOG(1-2GM/R)/2-MU=",0.5D0*DLOG(DBS)-MNUR,"Et=",ET
...
C   MI is moment of inertia in 10^45 g cm^2 of NS
 ...
 20    PMIN=1.0D-9
       ...
       PRINT*,"LOG(1-2GM/R)/2-MU=",KC,"Et=",ET
...
C     &    *AICORR*Po
     ...
     &     *(1.D0-2.D0*GS*4.D0*PI*XA*XA*EDEN)
      FOUR=(1.D0/3.D0)
...
C     &     /(1.D0-DAICORR)
      FIVE=4.D0*PI*DFED(PRESS)*(EDEN+PRESS)*Po
      SIX=(1.D0/12.D0)*(EJ**2)*(XA**4)*(DOMEGABAR**2)/GS
C      SEVEN=(-1.D0/3.D0)*(XA**3)*(DJKUADRAT)*(OMEGABAR**2)*AICORR/GS
      SEVEN=(-1.D0/3.D0)*(XA**3)*(DJKUADRAT)*(OMEGABAR**2)/GS
      EK(J,7)=H*(FIVE+SIX+SEVEN)/MSS
